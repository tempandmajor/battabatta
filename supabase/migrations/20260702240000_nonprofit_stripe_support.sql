...
alter table public.profile_private
  ...
  add column if not exists subscription_latest_invoice_id text,
...
create index if not exists donations_profile_created_at_idx on public.donations (profile_id, created_at desc);
create index if not exists profile_private_stripe_subscription_id_idx
  on public.profile_private (stripe_subscription_id)
